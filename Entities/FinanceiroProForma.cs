...
namespace Entities
{
    public class FinanceiroProForma
    {
        ...
        public List<FinanceiroProForma> lstItens { get; set; }
        public string Modal { get; set; }
        public List<FinanceiroProForma> lstInforme { get; set; }
        public string DescricaoInforme { get; set; }
        public List<FinanceiroProForma> lstReprocessamento { get; set; }
