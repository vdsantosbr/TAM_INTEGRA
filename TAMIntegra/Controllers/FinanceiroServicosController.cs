...
{
    public class FinanceiroServicosController : Controller
    {
        ...
        public void CarregarDados()
        {
            ...
            List<Perfil> lstPerfis = perfilBUS.Parametrizacao(usr.Id_Perfil).Where(x => x.Formulario == "frmFinanceiroServico").ToList();
